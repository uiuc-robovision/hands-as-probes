...
def main(args):
	...
	args.out_path = args.out_path + "/ACP_metadata/"
	...
	training_videos = sorted(set([os.path.basename(i)[:-4] for i in detection_files]))
	
	textfile = open(f"{args.out_path}/ACP_training_videos_nosupervision.txt", "w")
	for element in training_videos:
...
if __name__ == "__main__":
	...
	parser.add_argument('--det_path', dest='det_path', type=str,
						default="/data01/smodi9/datasets/EPIC-KITCHENS/detections_partitioned")
